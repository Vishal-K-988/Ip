      ...
      <div class="content-wrapper">
         ...
         <div class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6">
                     <h1 class="m-0" style="color: rgb(31,108,163);"><span class="fa fa-file-word"></span> Exam Result
                        Details</h1>
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-6">
                        ...
                        <table class="table align-items-center mb-0">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td>Lorem ipsum dolor sit amet, consectetur adipiscing elit, <br>sed do eiusmod tempor
