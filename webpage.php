...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="position-sticky pt-3">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link text-dark" href="student/index.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="nav-item">
              <a class="nav-link text-dark" href="student/result.ph">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <img src="dashboard.jpg" class="d-flex justify-content-center align-items-center " 
          alt="">
 ...
 <hr class="featurette-divider  mx-1"> 
        ...
        <div class="table-responsive">
          <table class="table table-striped table-sm">
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>   <strong>   Change of Name  </strong>  </td>
                <td>Academics</td>
                <td>28th May 2022</td>
                <td>Mr. Pabhu</td>
              </tr>
